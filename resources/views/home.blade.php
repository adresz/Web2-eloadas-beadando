                ...
                <div id="cityCarousel" class="carousel slide" data-bs-ride="false">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
                            <div class="d-flex justify-content-center align-items-center px-3" style="min-height: 480px;">
                                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                                    <a href="#<?= $c['slug'] ?>" class="text-decoration-none d-block h-100">
                                        <div class="card h-100 shadow-lg hover-shadow city-card border-0 rounded-4 overflow-hidden">
                                            <div class="position-relative overflow-hidden" style="height: 260px;">
                                                <img src="<?= $c['img'] ?>" 
                                                     ...
                                                     loading="lazy">
                                                <div class="position-absolute top-0 start-0 w-100 h-100 bg-gradient-dark hover-overlay"></div>
                                            </div>
                                            <div class="card-body d-flex flex-column justify-content-center text-center p-4 p-md-5">
                                                <h3 class="card-title text-primary fw-bold mb-3 fs-3"><?= $c['name'] ?></h3>
                                                <p class="card-text text-muted small lh-lg"><?= mb_substr($c['desc'],0,90) ?>...</p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
