    ...
    <div class="inner">
        ...
        <nav id="nav">
            <ul>
                ...
                <li class="{{ Route::is('lelekszam.index') ? 'active' : '' }}">
                    <a href="{{ route('lelekszam.index') }}">CRUD</a>
                </li>
...
<!-- JS Stack (Itt kerül betöltésre minden @push('scripts') tartalom) -->
